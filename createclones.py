...
for i in range(0, 100):
    ...
    product.title = f"Sole Elegance: A Stiletto Story {i}"
    ...
    product.category = ProductCategory.objects.first()
    product.set_current_language("ru")
    product.title = f"Изысканная подошва: История стилетов {i}"
